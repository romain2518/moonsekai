...
| /back-office/contact-request/{id}/mark-as-processed | POST | ContactRequest | markAsProcessed | |
| /back-office/contact-request/{id}/mark-as-unprocessed | POST | ContactRequest | markAsUnprocessed | |
| /back-office/contact-request/{id}/mark-as-important | POST | ContactRequest | markAsImportant | |
| /back-office/contact-request/{id}/mark-as-not-important | POST | ContactRequest | markAsNotImportant | |
| /back-office/contact-request/{id}/delete | POST | ContactRequest | delete | |
| /back-office/report/{limit}/{offset} | GET | Report | index | |
| /back-office/report/{id}/mark-as-processed | POST | Report | markAsProcessed | |
| /back-office/report/{id}/mark-as-unprocessed | POST | Report | markAsUnprocessed | |
| /back-office/report/{id}/mark-as-important | POST | Report | markAsImportant | |
| /back-office/report/{id}/mark-as-not-important | POST | Report | markAsNotImportant | |
