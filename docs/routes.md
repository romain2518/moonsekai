...
| /back-office/user/{id}/reset-picture | GET | User | edit | |
| /back-office/user/{id}/reset-banner | GET | User | edit | |
| /back-office/user/{id}/reset-pseudo | GET | User | edit | |
| /back-office/user/{id}/reset-biography | GET | User | edit | |
| /back-office/user/{id}/mute | GET | User | edit | |
| /back-office/user/{id}/unmute | GET | User | edit | |
