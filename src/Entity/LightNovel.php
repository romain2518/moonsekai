...
class LightNovel
{
    ...
    #[Vich\UploadableField(mapping: 'light-novel_pictures', fileNameProperty: 'picturePath')]
    #[Assert\File(
        maxSize: "5M",
    ...
    #[CustomAssert\NotBlankVich(message: 'Please provide a picture to create a light novel.', target: 'picturePath')]
    ...
    #[ORM\ManyToOne(inversedBy: 'lightNovels', fetch: 'EAGER')]
